# Generated by Django 4.1.6 on 2023-10-13 22:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'mentor'), (2, 'reception'), (3, 'accountant'), (4, 'director')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(1, 'active'), (2, 'in_group'), (3, 'leave'), (4, 'graduated'), (5, 'passive')], default=1)),
                ('full_name', models.CharField(max_length=250)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('phone', models.CharField(max_length=250)),
                ('address', models.CharField(max_length=250)),
                ('extra_phone', models.CharField(max_length=250)),
                ('debt', models.DecimalField(decimal_places=2, max_digits=22)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('money', models.DecimalField(decimal_places=2, max_digits=24)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
